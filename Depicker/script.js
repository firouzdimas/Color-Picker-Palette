...
window.onload = () => {
    //cek apakah browser support dengan eye dropper
    if ("EyeDropper" in window) {
        pickColor.classList.remove("hide");
        eyeDropper = new EyeDropper();
    } else {
        error.classList.remove("hide");
        error.innerText = "Browser tidak support EyeDropper API";
...
//user dapat memilih image berdasarkan keinginan user
fileInput.onchange = () => {
...
//fungsi untuk copy color code
let copy = (textId) => {
    //pilih text / input elemen
